...
static void emit_to_asm_linux_x86_64(ASM * self, IR_Inst_Blk * ir_blk) {
...
static void asm_linux_x86_64_emit(ASM * self, FILE * stream) {
...
ASM asm_linux_x86_64(Alloc * alloc, IR_Inst_Blk * ir_blk) {
    ASM assembly = {
        .alloc = alloc
        , .emit = asm_linux_x86_64_emit
    };

    emit_to_asm_linux_x86_64(&assembly, ir_blk);
